...
class SystemLogger:
    ...
    def get_tail(self, limit: int = 50, level: Optional[str] = None, subsystem: Optional[str] = None) -> List[LogEntry]:
    ...
    def get_since(self, timestamp: float, level: Optional[str] = None, subsystem: Optional[str] = None) -> List[LogEntry]:
